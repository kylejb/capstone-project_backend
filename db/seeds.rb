...
buoy_mdata = MeteorologicalData.create!(wind_dir: 230, wind_speed: 1.0, wind_gust: 2.0, wave_height: 0.9, dom_wave_period: 11, avg_wave_period: 6.8, wave_dir: 114, sea_pressure: 1016.3, sea_temp: 22.1, recorded_data_at: DateTime.new(2020, 9, 17, 17, 50), buoy: buoy)
